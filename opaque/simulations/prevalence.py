...
class PrevalenceSimulation(object):
    ...
    fixed : bool
        ...
        set to fixed values.
    """
    def __init__(self, sensitivity, specificity, samples_per_trial=100,
    ...
    def run(self, n_trials=1000, n_jobs=1):
        points = ((theta, *self.sample_sens_spec(), self.samples_per_trial,
